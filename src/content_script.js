(function () {
  ...
  /**
   * Update view every 15s
   */
  setInterval(() => m.redraw(), 15000)
  ...
  const Summary = {
    view: function () {
      ...
      return [
        m('tr.head', [
          m('td[colSpan=2]', 'En bref'),
        ]),
        m('tr', [
          m('td.libelle', 'Temps de travail'),
          m('td', minutesToString(worktime))
        ]),
        m('tr', [
        ...
        m('tr', [
          m('td.libelle', 'Fin de la journée'),
          m('td', dateToString(endOfDay))
        ]),
        m('tr', { style: borderTop }, [
          m('td.libelle', 'Etat horaire J-1'),
          m('td', minutesToString(monthlyDiff))
        ]),
        m('tr', [
          m('td.libelle', 'Etat horaire actuel'),
          m('td', minutesToString(currentDiff))
        ])
      ]
    }
  }
